...
import { VehicleType } from "@main/backend/resources/vehicle/modules/vehicle-type/entities/vehicle-type.entity";
import { PriceTableHour } from "../price-table-hour/entities/price-table-hour.entity";
